"""
Email delivery for OTP and future notifications.
Uses SMTP (Gmail App Password). Failures are logged and surfaced safely (no OTP leak).
"""
import smtplib
...
def send_otp_email(to_email: str, otp: str, app_name: str = "quiz management system") -> bool:
    ...
    Caller must only pass the plain OTP here; this function does not store it.
    """
