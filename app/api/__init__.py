...
from app.api.question_banks.routes import question_bank_ns
from app.api.quizzes.routes import quiz_ns
from app.api.questions.routes import question_ns
from app.api.answers.routes import answer_ns
from app.api.attempts.routes import attempt_ns
from app.api.files.routes import files_ns
from app.api.processing.routes import processing_ns
