"""
Quizzes business logic. Uses localized messages (message_key + lang).
"""
from app.repositories.message_repository import get_message, get_message_format
from app.services.quiz_service import create_quiz_from_bank as _create_quiz_from_bank
...
def create_quiz_from_bank(
    ...
    quiz, err = _create_quiz_from_bank(
